   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.INSTANCE.ffi_harness_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_harness_rustbuffer_free(buf, status)
        }
    }
...
internal open class UniffiVTableCallbackInterfaceToolProvider(
    @JvmField internal var `getTools`: UniffiCallbackInterfaceToolProviderMethod0? = null,
    @JvmField internal var `callTool`: UniffiCallbackInterfaceToolProviderMethod1? = null,
    @JvmField internal var `uniffiFree`: UniffiCallbackInterfaceFree? = null,
) : Structure() {
    class UniffiByValue(
        `getTools`: UniffiCallbackInterfaceToolProviderMethod0? = null,
        `callTool`: UniffiCallbackInterfaceToolProviderMethod1? = null,
        `uniffiFree`: UniffiCallbackInterfaceFree? = null,
    ): UniffiVTableCallbackInterfaceToolProvider(`getTools`,`callTool`,`uniffiFree`,), Structure.ByValue

   internal fun uniffiSetValue(other: UniffiVTableCallbackInterfaceToolProvider) {
        `getTools` = other.`getTools`
        `callTool` = other.`callTool`
...
fun uniffi_harness_checksum_method_toolprovider_call_tool(
): Short
fun ffi_harness_uniffi_contract_version(
): Int
...
fun ffi_harness_rust_future_cancel_u8(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_i8(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_u16(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_i16(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_u32(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_i32(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_u64(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_i64(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_f32(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_f64(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_pointer(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_rust_buffer(`handle`: Long,
): Unit
...
fun ffi_harness_rust_future_cancel_void(`handle`: Long,
): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_harness_uniffi_contract_version()
...
open class ToolProviderImpl: Disposable, AutoCloseable, ToolProvider
{
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_harness_fn_free_toolprovider(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_harness_fn_clone_toolprovider(pointer!!, status)
        }
    }
...
internal object uniffiCallbackInterfaceToolProvider {
    internal object `getTools`: UniffiCallbackInterfaceToolProviderMethod0 {
    ...
    internal object uniffiFree: UniffiCallbackInterfaceFree {
        override fun callback(handle: Long) {
            FfiConverterTypeToolProvider.handleMap.remove(handle)
        }
    }

    internal var vtable = UniffiVTableCallbackInterfaceToolProvider.UniffiByValue(
        `getTools`,
        `callTool`,
        uniffiFree,
    )
    ...
    internal fun register(lib: UniffiLib) {
        lib.uniffi_harness_fn_init_callback_vtable_toolprovider(vtable)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeToolProvider: FfiConverter<ToolProvider, Pointer> {
    internal val handleMap = UniffiHandleMap<ToolProvider>()

    override fun lower(value: ToolProvider): Pointer {
        return Pointer(handleMap.insert(value))
    }

    override fun lift(value: Pointer): ToolProvider {
        return ToolProviderImpl(value)
    }

    override fun read(buf: ByteBuffer): ToolProvider {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: ToolProvider) = 8UL

    override fun write(value: ToolProvider, buf: ByteBuffer) {
 ...
 * @suppress
 */
public object FfiConverterTypeMcpTool: FfiConverterRustBuffer<McpTool> {
    override fun read(buf: ByteBuffer): McpTool {
        return McpTool(
...
public object FfiConverterSequenceTypeMcpTool: FfiConverterRustBuffer<List<McpTool>> {
    override fun read(buf: ByteBuffer): List<McpTool> {
        val len = buf.getInt()
        return List<McpTool>(len) {
            FfiConverterTypeMcpTool.read(buf)
        }
    }

    override fun allocationSize(value: List<McpTool>): ULong {
        val sizeForLength = 4UL
        val sizeForItems = value.map { FfiConverterTypeMcpTool.allocationSize(it) }.sum()
        return sizeForLength + sizeForItems
    }

    override fun write(value: List<McpTool>, buf: ByteBuffer) {
        buf.putInt(value.size)
        value.iterator().forEach {
            FfiConverterTypeMcpTool.write(it, buf)
        }
    }
}
